...
@section('content')
    <div class="container">
        <h1 class="text-center mt-4">Editar Nosotros</h1>
        <div class="mt-5 row justify-content-center">
            <form
                class="col-md-9 col-xs-12 card card-body"
                action="{{route('nosotros.update',['nosotros'=>$nosotros->id])}}"
                method="POST"
            ...
            @csrf
                ...
                <fieldset class="border p-4">
                    ...
                    <div class="form-group">
                        <label for="imagen" class="h4 mt-3">Imagen de la especialidad</label>
                        <input
                            type="file"
                            id="imagen"
                    ...
                    <div class="mt-4">
                        <p>Imagen actual:</p>
                        <img src="/storage/{{$nosotros->imagen}}" style="width: 300px">
                    </div>
                    </div>
                    <div class="form-group">
