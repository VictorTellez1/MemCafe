        ...
        <div class="mt-5 row justify-content-center">
            ...
            @csrf
                <fieldset class="border p-4">
                    ...
                    <div class="form-group">
                        <label for="nombre" class="h4 mt-3">Nombre</label>
                        <input
                            type="text"
                            id="nombre"
                    ...
                    <div class="form-group">
                        <label for="apellido" class="h4 mt-3">Apellido</label>
                        <input
                            type="text"
                            id="apellido"
                    ...
                    <div class="form-group">
                        <label for="telefono" class="h4 mt-3">Telefono</label>
                        <input
                            type="number"
                            id="telefono"
                    ...
                    <div class="form-group">
                        <label for="Correo" class="h4 mt-3">Correo</label>
                        <input
                            type="email"
                            id="correo"
